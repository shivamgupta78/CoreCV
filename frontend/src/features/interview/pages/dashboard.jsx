                    ...
                    <div className='panel panel--right'>
                        ...
                        <div className='upload-section'>
                            ...
                            <label className='dropzone' htmlFor='resume'>
                                ...
                                <p className='dropzone__subtitle'>{selectedFile ? `${(selectedFile.size / (1024 * 1024)).toFixed(2)} MB` : 'PDF or DOCX (Max 5MB)'}</p>
                                <input
                                 ref={resumeInputRef} onChange={handleFileChange} 
